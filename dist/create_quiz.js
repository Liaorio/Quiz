    ...
    createQuiz.prototype = {
        ...
        htmlElementJoint: function htmlElementJoint() {
            ...
            $.each(questions, function (key, val) {
                ...
                quizHtml += "<div class='slick-item' id='slick-item-" + key + "'>" + "<div class='quiz-image " + hasImage + "'>" + "<img src='" + val.img + "'>" + "</div>" + "<div class='quiz-question' id='slick-item-question-" + key + " '>" + "<div class='quiz-question-num-container'>" + "<div class='quiz-question-num'>" + (key + 1) + "</div>" + "</div>" + "<div class='quiz-question-text'>" + val.question + "</div>" + "<div class='quiz-question-options'>" + "<ul class='quiz-question-options-ul' id='question_" + key + "'>" + "<li class='quiz-question-options-li " + isShown1 + "' id='question_" + key + "_1_li'>" + "<input type='radio' class='magic-radio' name='question_" + key + "' id='question_" + key + "_1_option'>" + "<label class='option-text' for='question_" + key + "_1_option'>" + val.options1 + "</label>" + "</li>" + "<li class='quiz-question-options-li " + isShown2 + "' id='question_" + key + "_2_li'>" + "<input type='radio' class='magic-radio' name='question_" + key + "' id='question_" + key + "_2_option'>" + "<label class='option-text' for='question_" + key + "_2_option'>" + val.options2 + "</label>" + "</li>" + "<li class='quiz-question-options-li " + isShown3 + "' id='question_" + key + "_3_li'>" + "<input type='radio' class='magic-radio' name='question_" + key + "' id='question_" + key + "_3_option'>" + "<label class='option-text' for='question_" + key + "_3_option'>" + val.options3 + "</label>" + "</li>" + "<li class='quiz-question-options-li " + isShown4 + "' id='question_" + key + "_4_li'>" + "<input type='radio' class='magic-radio' name='question_" + key + "' id='question_" + key + "_4_option'>" + "<label class='option-text' for='question_" + key + "_4_option'>" + val.options4 + "</label>" + "</li>" + "</ul>" + "</div>" + "<div class='quiz-process'>" + (key + 1) + "/" + number + "</div>" + "</div>" + "<div class='nextButton onlyNext invisible' id='next_" + key + "'>" + "Next" + "</div>" + "</div>";
            });

            quizHtml += "<div class='slick-item'>" + "<div class='score-div'>" + "<h1>" + "Your Score" + "</h1>" + "<div class='score-part'>" + "<span class='score' id='final-score'>" + 0 + "</span>" + "&nbsp;&nbsp;/&nbsp;&nbsp;" + "<span class='score'>" + number + "</span>" + "</div>" + "<h1>" + "Let your friends and the word know" + "</h1>" + "<div class='icon-list'>" + "<div class='share'>" + "<a class='mail' href='#' target='_blank'><img src='./asset/mail@3x.png'></a>" + "<a class='mail' href='#' target='_blank'><img src='./asset/facebook@3x.png'/></a>" + "<a class='mail' href='#' target='_blank'><img src='./asset/wechat@3x.png'/></a>" + "<a class='mail' href='#' target='_blank'><img src='./asset/weibo@3x.png'/></a>" + "<a class='mail' href='#' target='_blank'><img src='./asset/twitter@3x.png'/></a>" + "<a class='mail' href='#' target='_blank'><img src='./asset/tumblr@3x.png'/></a>" + "</div>" + "</div>" + "</div>" + "<div class='restartButton nextButton' data-restart='true'>" + "Start it again" + "</div>" + "</div>";
        ...
        addQuizFunction: function addQuizFunction() {
            ...
            $('input[type="radio"]').change(function (e) {
                ...
                $('.quiz-result').html("<div class='quiz-result-title'>" + result + "!" + "</div>" + "<div class='quiz-result-text'>" + feedback + "</div>");
